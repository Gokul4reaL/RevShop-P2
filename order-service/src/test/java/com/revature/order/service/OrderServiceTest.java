...
public class OrderServiceTest {
	...
	/*
	 * @Test public void testCreateOrder_Success() { Order order = new Order();
	 * order.setId(1L);
	 * 
	 ...
	 * 
	 * assertNotNull(result); assertEquals(1L, result.getId()); }
	 */
	...
	/*
	 * @Test public void testGetOrderById_Success() { Long orderId = 1L; Order order
	 * = new Order(); order.setId(orderId);
	 * 
	 * when(orderRepository.findById(orderId)).thenReturn(Optional.of(order));
	 * 
	 * Optional<Order> result = orderService.getOrderById(orderId);
	 * 
	 * assertTrue(result.isPresent()); assertEquals(orderId, result.get().getId());
	 * }
	 */
