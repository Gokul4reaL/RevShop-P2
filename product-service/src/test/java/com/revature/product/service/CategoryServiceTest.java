...
public class CategoryServiceTest {
	...
	/*
	 * @Test public void testCreateCategory_Success() { Category category = new
	 * Category(); category.setName("New Category");
	 * 
	 * when(categoryRepository.save(any(Category.class))).thenReturn(category);
	 * 
	 * Category createdCategory = categoryService.createCategory(category);
	 * 
	 * assertNotNull(createdCategory); assertEquals("New Category",
	 * createdCategory.getName()); }
	 */

    // Test for getting a category by ID (Success)
	/*
	 * @Test public void testGetCategoryById_Success() { Long categoryId = 1L;
	 ...
	 * 
	 * assertTrue(retrievedCategory.isPresent()); assertEquals("Test Category",
	 * retrievedCategory.get().getName()); }
	 */
	...
	/*
	 * @Test public void testUpdateCategory_Success() { Long categoryId = 1L;
	 * Category category = new Category(); category.setId(categoryId);
	 ...
	 * 
	 * Category updatedCategory = categoryService.updateCategory(categoryId,
	 * updatedCategoryDetails);
	 * 
	 * assertNotNull(updatedCategory); assertEquals("Updated Category",
	 * updatedCategory.getName()); assertEquals("updated_image.jpg",
	 * updatedCategory.getImageName()); }
	 */
	/*
	 * // Test for updating a category (Failure)
	 * 
	 * @Test public void testUpdateCategory_Failure() { Long categoryId = 1L;
	 * Category updatedCategoryDetails = new Category();
	 * updatedCategoryDetails.setName("Updated Category");
	 * 
	 * when(categoryRepository.findById(categoryId)).thenReturn(Optional.empty());
	 ...
	 * 
	 * @Test public void testDeleteCategory_Success() { Long categoryId = 1L;
	 * Category category = new Category(); category.setId(categoryId);
	 * 
	 * when(categoryRepository.findById(categoryId)).thenReturn(Optional.of(category
