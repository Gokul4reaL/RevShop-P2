...
public class ProductServiceTest {
	...
	/*
	 * @Test public void testCreateProduct_Success() { Product product = new
	 * Product(); product.setName("New Product");
	 * 
	 * when(productRepository.save(any(Product.class))).thenReturn(product);
	 * 
	 * Product createdProduct = productService.createProduct(product);
	 * 
	 * assertNotNull(createdProduct); assertEquals("New Product",
	 * createdProduct.getName()); }
	 */

    // Test for getting a product by ID (Success)
	/*
	 * @Test public void testGetProductById_Success() { Long productId = 1L; Product
	 * product = new Product(); product.setId(productId);
	 ...
	 * 
	 * assertTrue(retrievedProduct.isPresent()); assertEquals("Test Product",
...
//    }
	...
	/*
	 * @Test public void testUpdateProduct_Failure() { Long productId = 1L; Product
	...
	/*
	 * @Test public void testDeleteProduct_Success() { Long productId = 1L; Product
	 * product = new Product(); product.setId(productId);
	 * 
	 * when(productRepository.findById(productId)).thenReturn(Optional.of(product));
	...
	/*
	 * @Test public void testGetProductsByCategoryId_Success() { Long categoryId =
	 * 1L; List<Product> productList = new ArrayList<>(); Product product = new
	 * Product(); product.setName("Category Test Product");
