...
public class ProductControllerTest {
	 ...
	 * assert(response.getStatusCode() == HttpStatus.OK); assert(response.getBody()
	 * != null); assert(response.getBody().getName().equals("Test Product")); }
	 */
	 ...
	 * Product(); product.setId(1L); product.setName("Category Test Product");
	 * productList.add(product);
	 * 
	 * when(productService.getProductsByCategoryId(categoryId)).thenReturn(
	 * productList);
	 * 
	 ...
	 * assert(response.getStatusCode() == HttpStatus.OK); assert(response.getBody()
	 * != null); assert(!response.getBody().isEmpty()); }
	 */
